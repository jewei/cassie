          ...
          <div class="px-4 sm:px-6 lg:px-8">
            <div class="sm:flex sm:items-center">
              ...
              <div class="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
                <Link :href="route('templates.index')" class="mx-4 font-medium text-gray-500 hover:text-gray-700"
                  >Back
                </Link>
                <Link
                ...
                <div v-if="participants.length > 0" class="inline-flex rounded-md shadow-sm">
                  <Link
                    :href="route('templates.certificates.create', props.template)"
                    type="button"
                    class="relative inline-flex items-center rounded-l-md border border-gray-300 bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 focus:z-10 focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                        ...
                        >
                          ...
                          <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                            ...
                            <a
                              v-if="participant.rendered_at"
                              :href="
                                route('templates.certificates.show', [props.template.id, participant.id]) +
                                '?download=1'
                              "
                            ...
                            <span
                              v-if="!participant.rendered_at"
                              @click="router.reload({ only: ['participants'] })"
                              class="text-gray-500"
                              >Generating...</span
                            >
                          </td>
