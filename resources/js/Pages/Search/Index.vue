                    ...
                    <div class="mx-auto max-w-3xl sm:px-6 lg:px-8">
                        <div
                            ...
                            <h2
                                ...
                                Verify a certificate.</h2>
                            <p class="mx-auto mt-2 max-w-xl text-center text-lg leading-8 text-gray-300">The Certificate ID
                                can be found at the bottom of each certificate.</p>
                            <form @submit.prevent="submit" class="mx-auto mt-10 flex max-w-md gap-x-4">
                                <label for="uuid" class="sr-only">Certificate ID</label>
                                <input id="uuid" name="uuid" type="text" v-model="form.uuid" autofocus
                                ...
                                <button type="submit"
                                    class="flex-none rounded-md bg-white py-1.5 px-3.5 text-base font-semibold leading-7 text-gray-900 shadow-sm hover:bg-gray-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white">Validate</button>
                                
                            </form>
                            <InputError class="mt-4 mx-auto flex max-w-md" :message="form.errors.uuid" />
                            <a v-if="url" :href="props.url" class="mt-4 mx-auto flex max-w-md text-green-500 font-semibold">Valid!</a>
